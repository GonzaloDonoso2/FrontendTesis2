        ...
        <main>
            ...
            <div class="container form-control">
                ...
                <div class="input-group mb-3">                   
                    ...
                    <button class="btn btn-outline-primary" id="botonBuscarUsuario" title="Busque a otros usuarios por su nombre para desafiarlos a una batalla." onclick="buscarUsuario()" type="button"><b>Buscar Usuario</b> <i class="fa-solid fa-magnifying-glass"></i><i class="fa-solid fa-users"></i></button>      
                </div>
                ...
                <button class="btn btn-success" disabled id="botonAceptarDesafio" onclick="registrarDesafio()" title="Aceptar" type="button"><b>Aceptar</b> <i class="bi bi-shield-check"></i></button>
                <button class="btn btn-danger" disabled id="botonRechazarDesafio" title="Rechazar" type="button"><b>Rechazar</b> <i class="bi bi-shield-x"></i></button> 
            </div>
